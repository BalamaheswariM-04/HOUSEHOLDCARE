  ...
  return (
    <AppBar position="static" sx={{ backgroundColor: '#445' }}>
      <Toolbar>
        ...
        <Button color="inherit" component={Link} to="/CustomerHome" sx={{ color: 'white' }}>Home</Button>
        ...
        <Button color="inherit" component={Link} to="/Feedback" sx={{ color: 'white' }}>Review</Button>
        ...
        >
          <MenuItem onClick={handleProfileMenuClose} component={Link} to="/">Profile</MenuItem>
          <MenuItem onClick={handleProfileMenuClose} component={Link} to="/">Logout</MenuItem>
        </Menu>
      </Toolbar>
    </AppBar>
  );
